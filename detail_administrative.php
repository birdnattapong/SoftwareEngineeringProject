    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                <li>
                    <?php
                        echo "<a href='index_administrative.php?id=" . $id . "&name=" .$name. "'>";
                    ?>
        ...
        <div id="content">
            ...
            <div id="content-in">       
                ...
                <div id="All" class="d-flex justify-content-center"  class="tabcontent" style="display: block;">
                    <table class="table table-striped table-wrapper-scroll-y my-custom-scrollbar" cellspacing="0" style="width: fit-content !important; cursor: default;">
                        <?php   
